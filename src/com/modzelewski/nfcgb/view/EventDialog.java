...
public class EventDialog implements EventDialogInterface {
     ...
     */
    @Override
    public void addEvent(final BackgroundModel model, final Spinner eventSpinner, final EventAdapter eventAdapter, final GroupAdapter groupAdapter, final PersonAdapter personAdapter) {
     ...
     */
    @Override
    public void removeEvent(final BackgroundModel model, final EventAdapter eventAdapter, final GroupAdapter groupAdapter, final PersonAdapter personAdapter) {
        AlertDialog.Builder adb = new AlertDialog.Builder(context);
