...
public interface PersonDialogInterface {
	...
	public abstract void editPerson(DatabaseHelper dbh, BackgroundModel model, MenuItem item, PersonAdapter pa);

	public abstract void removePerson(DatabaseHelper dbh, BackgroundModel model, MenuItem item, PersonAdapter pa);
